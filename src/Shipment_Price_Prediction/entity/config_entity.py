...
class Model_Trainer_Config:
    ...
    def __init__(self):
        ...
        self.SCHEMA_CONFIG = self.UTILS.read_yaml_file(filename=MODEL_CONFIG_FILE)
        ...
        self.TRAINED_MODEL_FILE_PATH:str = os.path.join(from_root(),ARTIFACTS_DIR,MODEL_FILE_NAME)
